...
public class TimeUtil {
	...
	public final static String FORMAT_DATE8 = "yyyyMMdd";
	public final static String FORMAT_TIME6 = "HH:mm:ss";
	public final static String FORMAT_TIME = "hh:mm";
	public final static String FORMAT_FULLTIME = "yyyy-MM-dd HH:mm:ss";
	...
	public static String time6() {
		sdf.applyPattern(FORMAT_TIME6);
		return sdf.format(new Date());
	}
	
	public static String date8() {
		sdf.applyPattern(FORMAT_DATE8);
		return sdf.format(new Date());
	}
	
	public static String fullTime() {
		sdf.applyPattern(FORMAT_FULLTIME);
		return sdf.format(new Date());
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(TimeUtil.time6());
		System.out.println(TimeUtil.date8());
		System.out.println(TimeUtil.fullTime());
	}
}
