...
public class HttpUtils {
	...
	public static String sendPostUrl(String url, String param, String charset,String contentType) {
		...
		try {
			...
			MyLogger.error("发送 POST 请求出现异常！" + e);
		}
		// 使用finally块来关闭输出流、输入流
			...
			try {
				...
				MyLogger.error("send post appears io exception" ,ex);
			}
		}
		
		sendNum++;
		MyLogger.info("HTTP 第" + sendNum  + "次请求完成... ");
		return result;
	}
	/**
	 * POST请求，Map形式数据
